...
export namespace Prisma {
  ...
  */
  ...
  export type GetUserExampleAggregateType<T extends UserExampleAggregateArgs> = {
    [P in keyof T & keyof AggregateUserExample]: P extends 'count'
      ? T[P] extends true
        ? number
  ...
  export type UserExampleGroupByArgs = {
    ...
    take?: number
    skip?: number
    count?: UserExampleCountAggregateInputType | true
    avg?: UserExampleAvgAggregateInputType
    sum?: UserExampleSumAggregateInputType
    min?: UserExampleMinAggregateInputType
    max?: UserExampleMaxAggregateInputType
  ...
  type GetUserExampleGroupByPayload<T extends UserExampleGroupByArgs> = Promise<Array<
    PickArray<UserExampleGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof UserExampleGroupByOutputType))]: GetScalarType<T[P], UserExampleGroupByOutputType[P]>
    }
  >>
