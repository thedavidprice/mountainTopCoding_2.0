...
exports.maybeCopyToTmp = exports.resolveBinary = exports.BinaryType = exports.engineEnvVarMap = void 0;
...
Object.defineProperty(exports, "BinaryType", { enumerable: true, get: function () { return fetch_engine_1.BinaryType; } });
...
exports.engineEnvVarMap = {
    [fetch_engine_1.BinaryType.queryEngine]: 'PRISMA_QUERY_ENGINE_BINARY',
    [fetch_engine_1.BinaryType.libqueryEngineNapi]: 'PRISMA_QUERY_ENGINE_LIBRARY',
    [fetch_engine_1.BinaryType.migrationEngine]: 'PRISMA_MIGRATION_ENGINE_BINARY',
    [fetch_engine_1.BinaryType.introspectionEngine]: 'PRISMA_INTROSPECTION_ENGINE_BINARY',
    [fetch_engine_1.BinaryType.prismaFmt]: 'PRISMA_FMT_BINARY',
};
async function resolveBinary(name, proposedPath) {
    ...
    if (name === fetch_engine_1.BinaryType.libqueryEngineNapi) {
        ...
        if (!fs_1.default.existsSync(path_1.default.join(engines_1.getEnginesPath(), binaryName))) {
            ...
            await fetch_engine_1.download({
                binaries: {
                    'libquery-engine': engines_1.getEnginesPath(),
                },
