...
export declare type SupportedAuthClients = Auth0 | AzureActiveDirectory | DbAuth | GoTrue | NetlifyIdentity | MagicLink | Firebase | Supabase | Ethereum | Nhost | Custom;
...
export declare type SupportedUserMetadata = Auth0User | AzureActiveDirectoryUser | GoTrueUser | MagicUser | SupabaseUser | EthereumUser | NhostUser;
