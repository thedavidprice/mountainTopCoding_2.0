...
const pageFiles = (name, scaffoldPath = '', generateTypescript) => {
  ...
  (0, _forEach.default)(PAGES).call(PAGES, page => {
    ...
    const outputPath = _path.default.join((0, _lib.getPaths)().web.pages, pascalScaffoldPath, outputPageName.replace(/\.(js|tsx?)/, ''), outputPageName);
...
const componentFiles = async (name, scaffoldPath = '', generateTypescript) => {
  ...
  await (0, _lib.asyncForEach)(COMPONENTS, component => {
    ...
    const outputPath = _path.default.join((0, _lib.getPaths)().web.components, pascalScaffoldPath, outputComponentName.replace(/\.(js|tsx?)/, ''), outputComponentName);
...
const addLayoutImport = ({
  ...
  const newRoutesContent = routesContent.replace(/'@redwoodjs\/router'(\s*)/, `'@redwoodjs/router'$1${importLayout}$1`);
