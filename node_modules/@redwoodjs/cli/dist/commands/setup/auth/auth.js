...
const addWebRender = (content, authProvider) => {
  ...
  const redwoodApolloProviderLines = (0, _map.default)(_context5 = redwoodApolloProvider.split('\n')).call(_context5, line => {
    return '  ' + line;
  });
  const customRenderOpen = (0, _reduce.default)(_context6 = authProvider.render || []).call(_context6, (acc, component) => acc + indent + `<${component}>`, '');
  const customRenderClose = (0, _reduce.default)(_context7 = authProvider.render || []).call(_context7, (acc, component) => indent + `</${component}>` + acc, '');
