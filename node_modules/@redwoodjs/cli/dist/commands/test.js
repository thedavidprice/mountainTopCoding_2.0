...
const handler = async ({
  ...
  const forwardJestFlags = (0, _flatMap.default)(_context = (0, _keys.default)(others)).call(_context, flagName => {
    ...
    if ((0, _includes.default)(_context2 = ['watch', 'collect-coverage', '$0', '_']).call(_context2, flagName)) {
  ...
  jestArgs.push('--config', `"${require.resolve('@redwoodjs/core/config/jest.config.js')}"`);
