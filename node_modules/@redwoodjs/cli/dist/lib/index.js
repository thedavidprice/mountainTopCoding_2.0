...
const cleanupEmptyDirsTask = files => {
  ...
  const allDirs = (0, _map.default)(_context7 = (0, _keys.default)(files)).call(_context7, file => _path.default.dirname(file));
...
const addRoutesToRouterTask = routes => {
  ...
  const newRoutesContent = (0, _reduce.default)(_context8 = (0, _reverse.default)(routes).call(routes)).call(_context8, (content, route) => {
...
const getDefaultArgs = builder => {
  ...
  return (0, _reduce.default)(_context9 = (0, _entries.default)(builder)).call(_context9, (options, [optionName, optionConfig]) => {
