...
exports.handlePrismaLogging = exports.emitLogLevels = exports.defaultLogLevels = exports.createLogger = exports.defaultLoggerOptions = exports.defaultPrettyPrintOptions = exports.logLevel = exports.redactionsList = exports.prettifier = exports.isPretty = exports.isProduction = exports.isTest = exports.isDevelopment = void 0;
...
var prettyPrint = _interopRequireWildcard(require("pino-pretty"));
...
const redactionsList = ['access_token', 'accessToken', 'DATABASE_URL', 'email', 'event.headers.authorization', 'host', 'jwt', 'JWT', 'password', 'params', 'secret'];
/**
...
const defaultPrettyPrintOptions = {
  colorize: true,
  ignore: 'hostname,pid',
  levelFirst: true,
  messageFormat: false,
...
exports.defaultPrettyPrintOptions = defaultPrettyPrintOptions;
...
const createLogger = ({
  ...
  const stream = destination; // override, but retain default pretty print options

  if (isPretty && options && options.prettyPrint) {
    const prettyOptions = {
      prettyPrint: { ...defaultLoggerOptions.prettyPrint,
        ...options.prettyPrint
      }
    };
  ...
  if (isFile) {
    ...
    if (isStream && options.prettyPrint) {
      console.warn('Logs sent to the transport stream are being prettified. This format may be incompatible.');
    }
