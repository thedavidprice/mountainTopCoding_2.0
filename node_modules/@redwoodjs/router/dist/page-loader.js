...
class PageLoader extends _react.default.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.stateChanged(prevState, this.state)) {
      ...
      const routeFocus = (0, _internal.getFocus)();

      if (!routeFocus) {
        (0, _internal.resetFocus)();
      } else {
        routeFocus.focus();
      }
    }
  ...
  render() {
    ...
    if (Page) {
      ...
      var _this$props$whileLoad, _this$props;

      return this.state.slowModuleImport ? ((_this$props$whileLoad = (_this$props = this.props).whileLoadingPage) === null || _this$props$whileLoad === void 0 ? void 0 : _this$props$whileLoad.call(_this$props)) || null : null;
    }
  }
