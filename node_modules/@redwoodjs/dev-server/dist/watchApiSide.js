...
// make sense.
const WATCHER_IGNORE_EXTENSIONS = ['.db', '.sqlite', '-journal', '.test.js', '.test.ts', '.scenarios.ts', '.scenarios.js', '.d.ts'];
...
const watchFunctions = ({
  ...
  const watcher = _chokidar.default.watch(paths.base, {
    ignored: file => (0, _includes.default)(file).call(file, 'node_modules') || (0, _includes.default)(file).call(file, rwjsPaths.api.dist) || (0, _includes.default)(file).call(file, rwjsPaths.api.types) || (0, _includes.default)(file).call(file, rwjsPaths.api.db) || (0, _some.default)(WATCHER_IGNORE_EXTENSIONS).call(WATCHER_IGNORE_EXTENSIONS, ext => (0, _endsWith.default)(file).call(file, ext))
  });
