...
(0, _apiBuild.build)({
  ...
  _chokidar.default.watch(rwjsPaths.api.base, {
    ...
    ignored: file => {
      ...
      return (0, _includes.default)(file).call(file, 'node_modules') || (0, _includes.default)(file).call(file, rwjsPaths.api.dist) || (0, _includes.default)(file).call(file, rwjsPaths.api.types) || (0, _includes.default)(file).call(file, rwjsPaths.api.db) || (0, _some.default)(_context = ['.db', '.sqlite', '-journal', '.test.js', '.test.ts', '.scenarios.ts', '.scenarios.js', '.d.ts']).call(_context, ext => (0, _endsWith.default)(file).call(file, ext));
    }
  }).on('ready', async () => {
    chokidarReady = true;
