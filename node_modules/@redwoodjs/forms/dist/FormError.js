...
const FormError = ({
  ...
  if (hasGraphQLError) {
    ...
    const errors = (_error$graphQLErrors$ = error.graphQLErrors[0].extensions) === null || _error$graphQLErrors$ === void 0 ? void 0 : (_error$graphQLErrors$2 = _error$graphQLErrors$.exception) === null || _error$graphQLErrors$2 === void 0 ? void 0 : _error$graphQLErrors$2.messages;
    rootMessage = (_error$graphQLErrors$3 = error.graphQLErrors[0].message) !== null && _error$graphQLErrors$3 !== void 0 ? _error$graphQLErrors$3 : 'Something went wrong.';
