...
const PURE_ANNOTATION = '#__PURE__'; // eslint-disable-next-line no-restricted-syntax
...
var _default = (0, _helperPluginUtils.declare)((api, options) => {
  ...
  const compile = (path, uniqueId) => {
    ...
    const finalSource = strip ? (0, _graphql.stripIgnoredCharacters)(source) : source;
    let queryDocument = (0, _graphqlTag.default)(strip ? (0, _graphql.stripIgnoredCharacters)(finalSource) : finalSource); // If a document contains only one operation, that operation may be unnamed:
    ...
    if (expressions.length) {
      ...
      definitionsProperty.value = callExpression(uniqueId, [allDefinitions]); // Marking these function calls with an annotation indicating that
