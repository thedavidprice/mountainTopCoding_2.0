  ...
  <body class="antialiased">
    <div class="relative bg-gray-200">
      ...
      <div class="relative max-w-5xl mx-auto">
        ...
        >
          <h1 class="text-4xl">Become an Author</h1>
          <p>
            Fullstackrocket is a team of passionate developers, wishing to help
            startups to launch their service. Join us and benefit from an
            attractive commission: 25%, with no exclusivity commitment!
          </p>

          <p>And for the first 10 projects, ZERO % commission!</p>

          Your advantages as an author: - Attractive fixed commission (25%) - No
          sales limit - No exclusivity constraint Technical requirements: -
          quality code, commented & tested - a ready-to-deploy solution - with
          technical documentation - on a freemium stack (netlify, vercel, mongo
          atlas, ...) - with open source libraries (gatsby, react, angular, ...)
          Customer expectations - the solution sold must be your own creation
          that you de facto hold the license for. - 6 months of technical
          support - Patches and updates for 2 years Translated with
                ...
                <li class="mt-4 flex items-start">
                  ...
                  <div class="ml-3 text-left text-base leading-6 font-medium">
                    ...
                    <p class="text-gray-600">
                      your uploads are always processed first!
                    </p>
                  </div>
                </li>
                <li class="mt-4 flex items-start">
                  ...
                  <div class="ml-3 text-left text-base leading-6 font-medium">
                    <p class="text-gray-900 font-semibold leading-6 text-xl">
                      Access to all premium features
                    </p>
                    <p class="text-gray-600">4-band and 5-band splits</p>
                  </div>
                </li>
                <li class="mt-4 flex items-start">
                  <div class="flex-shrink-0">
                  ...
                  <div class="ml-3 text-left text-base leading-6 font-medium">
                    <p class="text-gray-900 font-semibold leading-6 text-xl">
                      Forever guaranteed exclusive pricing
                    </p>
                    <p class="text-gray-600">Really forever.</p>
                  </div>
                </li>
              </ul>
            </div>
                    ...
                    <div>
                      ...
                      >
                        <span
                          ...
                          ><span
                            class="mt-2 mr-1 text-3xl leading-none sm:text-3xl"
                            >$</span
