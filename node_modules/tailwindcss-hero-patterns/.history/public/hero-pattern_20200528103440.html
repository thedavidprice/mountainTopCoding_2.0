...
<html lang="en">
  ...
  >
    ...
    <div class="mx-auto text-center p-10">
      ...
      <div
        class="bg-gray-200 text-sm text-gray-500 leading-none border-2 border-gray-200 bg-white rounded-full inline-flex"
      >
        <select x-model="baseColor" class="h-8 bg-transparent">
