  ...
  <body class="antialiased">
    <div class="relative bg-gray-200">
      ...
      <div class="relative max-w-5xl mx-auto">
        <div class="flex flex-col min-h-screen lg:items-center lg:p-8">
          ...
          <div
            class="p-10 w-full m-10 flex flex-col flex-grow bg-white lg:shadow-2xl lg:rounded-lg lg:overflow-hidden"
          >
            And for the first 10 projects, <b>ZERO % commission</b>!
          </div>
          ...
          <div class="flex flex-col lg:flex-row">
            ...
            >
              <h1 class="flex items-center text-2xl font-bold mb-2">
                Your advantages as an author
              </h1>
              ...
              <ul class="text-xl w-11/12">
                <li class="mt-4 flex items-start">
                  ...
                  <div class="ml-3 text-left text-base leading-6 font-medium">
                    ...
                    <p class="text-gray-600">25% flat commission.</p>
                  </div>
                </li>
                ...
                <li class="mt-4 flex items-start">
                  ...
                  <div class="ml-3 text-left text-base leading-6 font-medium">
                    ...
                    <p class="text-gray-600">
                      Make money from the first sale!
                    </p>
                  </div>
                </li>
                <li class="mt-4 flex items-start">
