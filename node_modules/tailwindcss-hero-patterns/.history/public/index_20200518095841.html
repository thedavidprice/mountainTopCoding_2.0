    ...
    <div class="relative bg-gray-200">
      ...
      <div class="relative max-w-5xl mx-auto">
        <div class="flex flex-col min-h-screen lg:items-center lg:p-8">
          ...
          <div
            class="p-10 w-full m-10 bg-white lg:shadow-2xl lg:rounded-lg inline-block"
          >
          ...
          <div class="flex flex-col lg:flex-row w-full">
            <div
              class="p-10 flex flex-col flex-grow bg-white lg:mr-10 lg:shadow-2xl lg:rounded-lg lg:overflow-hidden"
            >
            ...
            <div
              class="max-w-lg mx-auto lg:max-w-none lg:mx-0 lg:col-start-4 lg:col-end-8 lg:row-start-1 lg:row-end-4 z-10"
            >
