            ...
            >
              <div class="relative z-10 rounded-lg shadow-xl">
                <div>
                  ...
                  <div class="flex justify-center transform -translate-y-1/2">
                    <span
                      class="inline-flex rounded-full border bg-teal-100 border-teal-400 text-teal-400 px-4 py-1 text-sm leading-5 font-semibold tracking-wider uppercase text-white"
                    >
                      or
                    </span>
                  </div>
