                ...
                <li class="mt-4 flex items-start">
                  <div class="flex-shrink-0">
                    ...
                    <li class="mt-4 flex items-start">
                      ...
                      <div class="ml-3 text-left text-base leading-6 font-medium">
                        <p class="text-gray-900 font-semibold font-medium">Priority queue</p>
                      ...
                      <li class="mt-4 flex items-start">
                        ...
                        <div class="ml-3 text-left text-base leading-6 font-medium">
                          <p class="text-gray-900 font-semibold leading-6 font-medium">Access to all upcoming premium features</p>
                          <p class=" text-gray-600">4-band and 5-band splits</p>
                        </div>
                      </li>
                      <li class="mt-4 flex items-start">
                        <div class="flex-shrink-0"><svg class="h-6 w-6 text-teal-500" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        </div>
