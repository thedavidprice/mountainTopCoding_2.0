                ...
                <li class="mt-4 flex items-start">
                  <div class="flex-shrink-0">
                    ...
                    <div class="ml-3 text-left text-base leading-6 font-medium">
                      <p class="text-gray-900 font-semibold text-xl">Unlimited songs downloads</p>
                    ...
                    <li class="mt-4 flex items-start">
                      ...
                      <div class="ml-3 text-left text-base leading-6 font-medium">
                        <p class="text-gray-900 font-semibold text-xl">Priority queue</p>
                      ...
                      <li class="mt-4 flex items-start">
                        ...
                        <div class="ml-3 text-left text-base leading-6 font-medium">
                          <p class="text-gray-900 font-semibold leading-6 text-xl">Access to all premium features</p>
