  ...
  <body class="antialiased">
    <div class="relative bg-gray-200">
      ...
      <div class="relative max-w-5xl mx-auto">
        <div class="flex flex-col min-h-screen items-center p-8">
          ...
          <div
            class="p-10 w-full m-10 bg-white md:shadow-2xl md:rounded-lg inline-block"
          >
          ...
          <div class="flex flex-col md:flex-row w-full">
            <div
              class="p-10 mb-10 flex flex-col flex-grow bg-white md:mr-10 md:shadow-2xl md:rounded-lg md:overflow-hidden"
            >
              ...
              <h1 class="flex items-center text-2xl font-bold mt-6 mb-2">
                What we expect
              </h1>
              ...
              <ul class="text-xl w-11/12">
                <li class="mt-4 flex items-start">
                  ...
                  <div class="ml-3 text-left text-base leading-6 font-medium">
                    ...
                    <p class="text-gray-600">
                      Commented & tested, with Technical documentation
                    </p>
                  </div>
                </li>
                ...
                <li class="mt-4 flex items-start">
                  ...
                  <div class="ml-3 text-left text-base leading-6 font-medium">
                    ...
                    <p class="text-gray-600">
                      aka netlify, vercel, mongo atlas, ...
                    </p>
                  </div>
                </li>
            ...
            <div
              class="w-full lg:max-w-lg mx-auto md:w-auto md:max-w-none md:mx-0 md:col-start-4 md:col-end-8 md:row-start-1 md:row-end-4 z-10"
            >
              <div class="relative z-10 rounded-lg shadow-xl">
                <div>
                  ...
                  <p
                    class="text-center text-lg leading-7 font-semibold font-display text-teal-500 uppercase tracking-widest pt-6 px-6"
                  >
                    Apply to become an author
                  </p>
                  <div class="bg-white rounded-lg px-6 pt-2 pb-10">
                    <form
                      name="contact"
                      method="post"
                      class="mt-10"
                    ...
                    >
                      ...
                      <div class="inputGroup">
                        <label htmlFor="message"
                          >Describe your application</label
                        >
                        <textarea name="message" required></textarea>
                      </div>
                      <button
                        class="w-full btn bg-primary-500 text-white hover:bg-primary-700"
                        type="submit"
                      >
                        Send
                      </button>
