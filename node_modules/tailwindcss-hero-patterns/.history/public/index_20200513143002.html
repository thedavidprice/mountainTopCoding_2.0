    ...
    <div class="relative bg-gray-200">
      ...
      <div class="relative max-w-5xl mx-auto">
        ...
        >
          ...
          <div class="flex">
            <div
              class="p-10 mx-10 flex flex-col flex-grow bg-white lg:shadow-2xl lg:rounded-lg lg:overflow-hidden"
            >
              <h1 class="flex items-center text-2xl font-bold mb-10">
                Benefit from your unlimited download subscription
              </h1>

              <ul class="text-xl w-10/12">
                <li class="mt-4 flex items-start">
                  <div class="flex-shrink-0">
                    ...
                    <div class="ml-3 text-left text-base leading-6 font-medium text-gray-500">
                      <div class="ml-3 text-left text-base leading-6 font-medium">
                        <div class="text-gray-900 font-semibold">Unlimited songs downloads</p>
                        <p class=" text-gray-600">your uploads are always processed first!</p>
                        </div>
                      </div>
                  </p>
                  </li>
                    ...
                    <li class="mt-4 flex items-start">
                      ...
                      <div class="ml-3 text-left text-base leading-6 font-medium">
                        <div class="text-gray-900 font-semibold">Priority queue</p>
                        <p class=" text-gray-600">your uploads are always processed first!</p>
                        </div>
                    </li>
                      <li class="mt-4 flex items-start"><div class="flex-shrink-0"><svg class="h-6 w-6 text-teal-500" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></div>
                      <p class="ml-3 text-left text-base leading-6 font-medium text-gray-500"><p>access to <strong>all upcoming premium features</strong> (4-band and 5-band splits)</p></p></li>
                      <li class="mt-4 flex items-start"><div class="flex-shrink-0"><svg class="h-6 w-6 text-teal-500" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></div><p class="ml-3 text-left text-base leading-6 font-medium text-gray-500">
                <p>Forever guaranteed <strong>exclusive pricing</strong></p></p></li>
              </ul>

            </div>

            <div
              class="bg-gray-100 max-w-lg mx-auto lg:max-w-none lg:mx-0 lg:col-start-4 lg:col-end-8 lg:row-start-1 lg:row-end-4 z-10"
            >
              <div class="relative z-10 rounded-lg shadow-xl">
                <div>
                  ...
                  <p
                  class="text-center text-lg leading-7 font-semibold font-display text-teal-500 uppercase tracking-widest pt-6  "
                >
                  Limited to the first 100 subscribers
                </p>
              <div class="bg-white rounded-t-lg px-6 pt-2 pb-10">
                    <div>
                      <h2
                      ...
                      >
                        <span
                          ...
                          >$199</span
                        ><span
                          class="px-3 flex items-start text-5xl leading-none tracking-tight font-medium text-gray-900 sm:text-7xl"
                          ><span
                            class="mt-2 mr-1 text-3xl leading-none sm:text-4xl"
                            >$</span
                          ><span>49</span></span
                        ><span
                  ...
                  <div class="flex justify-center transform -translate-y-1/2">
                    <span
                      class="inline-flex rounded-full border bg-teal-400  px-4 py-1 text-sm leading-5 font-semibold tracking-wider uppercase text-white"
                    >
                      or
                    </span>
                  </div>
                  ...
                  <div
                    class="border-t-2 border-gray-100 rounded-b-lg pb-8 px-6 bg-gray-50 sm:px-10"
                  >
                    <div class="mt-4">
                      <h2
                        class="mt-2 text-center text-3xl leading-9 font-semibold font-display text-gray-900 sm:-mx-6"
